...
async function warnAboutNodeSassBeingUnsupported(fs, filePath, logger) {
...
var _default = new _plugin.Transformer({
  async getConfig({
    ...
    if (options.sourceMaps) {
      config.sourceMap = true; // sources are created relative to the directory of outFile

      config.outFile = (0, _path.join)(options.projectRoot, 'style.css.map');
  ...
  async transform({
    ...
    await warnAboutNodeSassBeingUnsupported(options.inputFS, asset.filePath, logger);
