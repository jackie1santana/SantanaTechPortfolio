...
var _default = new _plugin.Optimizer({
  async optimize({
    ...
    let config = { ...(userConfig === null || userConfig === void 0 ? void 0 : userConfig.config),
      compress: { ...(userConfig === null || userConfig === void 0 ? void 0 : (_userConfig$config = userConfig.config) === null || _userConfig$config === void 0 ? void 0 : _userConfig$config.compress),
