  ...
  for (let bundle of bundles) {
    ...
    if (assetCount > 0) {
      ...
      for (let asset of largestAssets) {
        ...
        rows.push([(asset == largestAssets[largestAssets.length - 1] ? '└── ' : '├── ') + (0, _utils2.formatFilename)(asset.filePath, _chalk.default.reset), _chalk.default.dim(prettifySize(asset.size)), _chalk.default.dim(_chalk.default.green((0, _utils.prettifyTime)(asset.time)))]);
      }
